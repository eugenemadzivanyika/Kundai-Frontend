        ...
        <div style={{
          ...
          >
            ...
            <div style={{
              ...
              {/* TOP edge — trimmed by corner-radius (14px) on both sides so it doesn't
                  poke out through the rounded bezel corners of the front face */}
              <div style={{
                ...FACE_BASE,
              ...
              {/* LEFT edge — trimmed by corner-radius at the top so the rail doesn't
                  poke out above the rounded bezel curve */}
              <div style={{
                ...FACE_BASE,
              ...
              {/* RIGHT edge — same top trim as LEFT edge */}
              <div style={{
                ...FACE_BASE,
                width: LID_D, height: LID_H - 14,
                left: -LID_D / 2, top: -(LID_H - 14) / 2 + 7,
...
const SceneTwinPanel: React.FC<{ approved?: boolean; folding?: boolean }> = ({ approved, folding }) => (
  <>
    <Backdrop />
...
/* ─────────────────────────────────────────────────────────────
   ...
   and phone positions are all predictable and aligned.
───────────────────────────────────────────────────────────────*/
...
/* ─────────────────────────────────────────────────────────────
   SCREEN CONTENT
───────────────────────────────────────────────────────────────*/
const ScreenContent: React.FC<{ scene: Scene; twinApproved: boolean; folding?: boolean }> = ({ scene, twinApproved, folding }) => (
  <>
    <Dashboard
